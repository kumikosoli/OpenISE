...
public class Meau extends JFrame {
	...
	private JButton jba = new JButton("读者信息");
	private JButton jbb = new JButton("出版社信息");
	private JButton jbc = new JButton("书籍信息");
	private JButton jbd = new JButton("书籍类别信息");
	private JButton jbe = new JButton("借阅信息");
